...
<html>
<head>
    <title>PSAS Ghiyas Hafizh</title>
...
<body>
        ...
        <h3 class="card-header p-3"><i class="fa-solid fa-user"></i> Tugas Ghiyas Hafizh</h3>
                    <div class="card-body">
...
<footer style="position: fixed; bottom: 0; width: 100%; background-color: rgb(165, 245, 237); text-align:center;">
    Laravel v{{ Illuminate\Foundation\Application::VERSION }} (PHP v{{ PHP_VERSION }}) by Ghiyas Hafizh Web Programming 11
</footer>
</body>
</html>